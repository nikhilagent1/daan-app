...
class seeDetailsBook extends StatefulWidget {
  final int i;
  final String id;
  final String name;
  final String phone;
  ...
  @override
  State<seeDetailsBook> createState() =>
      _seeDetailsBookState(i, id, name, phone, lat1, long1, lat2, long2);
}

class _seeDetailsBookState extends State<seeDetailsBook> {
  int i;
  String id;
  String name;
  String phone;
  ...
  double lat2;
  double long2;
  _seeDetailsBookState(this.i, this.id, this.name, this.phone, this.lat1,
