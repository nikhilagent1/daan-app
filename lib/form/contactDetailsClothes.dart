...
class contactDetailsClothes extends StatefulWidget {
  final int i;
  final String id;
  final String name;
  final String phone;
  ...
  @override
  State<contactDetailsClothes> createState() =>
      _contactDetailsClothesState(i, id, name, phone, lat1, long1, lat2, long2);
}

class _contactDetailsClothesState extends State<contactDetailsClothes> {
  int i;
  String id;
  String name;
  String phone;
  ...
  _contactDetailsClothesState(this.i, this.id, this.name, this.phone, this.lat1,
