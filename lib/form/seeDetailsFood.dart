...
class seeDetailsFood extends StatefulWidget {
  ...
  @override
  State<seeDetailsFood> createState() =>
      _seeDetailsFoodState(i, id, name, phone, lat1, long1, lat2, long2);
}
...
class _seeDetailsFoodState extends State<seeDetailsFood> {
  ...
  _seeDetailsFoodState(this.i, this.id, this.name, this.phone, this.lat1,
