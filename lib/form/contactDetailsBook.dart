...
class contactDetailsBook extends StatefulWidget {
  final int i;
  final String id;
  final String name;
  final String phone;
  ...
  @override
  State<contactDetailsBook> createState() =>
      _contactDetailsBookState(i, id, name, phone, lat1, long1, lat2, long2);
}

class _contactDetailsBookState extends State<contactDetailsBook> {
  int i;
  String id;
  String name;
  String phone;
  ...
  _contactDetailsBookState(this.i, this.id, this.name, this.phone, this.lat1,
