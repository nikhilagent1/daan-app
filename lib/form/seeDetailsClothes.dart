...
class seeDetailsClothes extends StatefulWidget {
  final int i;
  final String id;
  final String name;
  final String phone;
  ...
  @override
  State<seeDetailsClothes> createState() =>
      _seeDetailsClothesState(i, id, name, phone, lat1, long1, lat2, long2);
}

class _seeDetailsClothesState extends State<seeDetailsClothes> {
  int i;
  String id;
  String name;
  String phone;
  ...
  _seeDetailsClothesState(this.i, this.id, this.name, this.phone, this.lat1,
